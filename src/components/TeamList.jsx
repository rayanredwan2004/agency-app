  ...
  return (
    <div>
      <div className="px-20 py-10">
        ...
        <div className="grid md:grid-cols-2 sm:grid-cols-1 lg:grid-cols-3 mt-8">
          {data.map((item) => (
            <div className="w-[300px] mb-10">
              <div className="relative">
                <Image
                  ...
                  alt="team1"
                />
                <ul className="absolute bottom-7 right-[101px] flex fill-gray-500 justify-center gap-2 py-2 px-4 bg-white rounded-full shadow-lg text-sm divide-x">
                  <li>
              ...
              <h1 className="shadow-xl font-semibold text-2xl text-center py-4 pb-6 rounded-xl">
                {item["name"]}
              </h1>
            </div>
          ))}
